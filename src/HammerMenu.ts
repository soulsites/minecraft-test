 ...
 * this is a button menu with exactly the recipes in `HammerRecipes` -
 * nothing else is craftable through it, and the vanilla anvil still works
 * normally when the Hammer isn't in hand.
 */
